...
class ServiceCors
{
    ...
    {
        $this->allowedOrigins         = $config->default['allowedOrigins'];
        $this->allowedOriginsPatterns = $config->default['allowedOriginsPatterns'];
        $this->allowedMethods         = $config->default['allowedMethods'];
        $this->allowedHeaders         = $config->default['allowedHeaders'];
        $this->supportsCredentials    = $config->default['supportsCredentials'];
        $this->maxAge                 = $config->default['maxAge'];
        $this->exposedHeaders         = $config->default['exposedHeaders'];
