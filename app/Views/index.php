...
<body>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box flex-md-row-reverse" data-aos="fade-up" data-aos-delay="100">
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center d-none d-lg-block"><i class="bi bi-arrow-up-short"></i></a>
